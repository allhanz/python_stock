...
def create_googlenet(weights_path=None):
    ...
    print("pool1_3x3_s2:",pool1_3x3_s2)
    #exit()
...
if __name__ == "__main__":
    ...
    print(file_list)
    img = imresize(imread('cat1.jpg', mode='RGB'), (224, 224)).astype(np.float32)
    print(img)
    img[:, :, 0] -= 123.68
    img[:, :, 1] -= 116.779
    img[:, :, 2] -= 103.939
    ...
    print("model json data:",json_data)
